...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function formatCategoryLabel(date) {
      var _a2, _b2;
      if (!date) {
        return "";
      }
      ...
      if (segments.length >= 2) {
        const month = (_a2 = segments[segments.length - 2]) == null ? void 0 : _a2.padStart(2, "0");
        const day = (_b2 = segments[segments.length - 1]) == null ? void 0 : _b2.padStart(2, "0");
        if (month && day) {
          return `${month}-${day}`;
        }
      }

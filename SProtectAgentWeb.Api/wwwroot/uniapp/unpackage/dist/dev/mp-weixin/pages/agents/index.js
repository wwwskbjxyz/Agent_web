  ...
  setup(__props) {
    ...
    async function searchAgents() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:391", "searchAgents error", error);
    ...
    async function refreshList() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:412", "refreshList error", error);
      }
    }
    async function changePage(page) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:421", "changePage error", error);
      }
    }
    async function onPageSizeChange(event) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:432", "onPageSizeChange error", error);
      }
    }
    ...
    async function toggleStatus(row, enable) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:474", "toggleStatus error", error);
    ...
    async function openAdjust(row) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:497", "openAdjust error", error);
    ...
    async function openRemark(row) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:512", "openRemark error", error);
    ...
    async function openPassword(row) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:531", "openPassword error", error);
    ...
    async function openAssignCardTypes(row) {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:544", "loadCardTypes error", error);
      }
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:566", "openAssignCardTypes error", error);
    ...
    async function deleteAgent(row) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:581", "deleteAgent error", error);
    ...
    async function openCreateAgent() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:600", "loadCardTypes error", error);
      }
      resetCreateAgentForm();
    ...
    async function submitCreateAgent() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:644", "submitCreateAgent error", error);
    ...
    common_vendor.onMounted(async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/agents/index.vue:673", "agents/onMounted error", error);
      }
      syncFiltersFromStore();
    });
    common_vendor.watch(
      ...
      async (next, prev) => {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/agents/index.vue:688", "selectedSoftware change error", error);
        }
        syncFiltersFromStore();
      }
    );

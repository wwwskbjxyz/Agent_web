  ...
  setup(__props) {
    ...
    async function onPageSizeChange(event) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:574", "onPageSizeChange error", error);
      }
    }
    async function submitSearch() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:607", "submitSearch error", error);
    ...
    async function refreshList() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:635", "refreshList error", error);
      }
    }
    async function changePage(page) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:644", "changePage error", error);
      }
    }
    ...
    async function handleStatusAction(row, action) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:677", "handleStatusAction error", error);
    ...
    async function handleUnbind(row) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:695", "handleUnbind error", error);
    ...
    async function submitCreateCard() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:758", "submitCreateCard error", error);
    ...
    common_vendor.onMounted(async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/cards/index.vue:842", "cards/onMounted error", error);
      } finally {
        syncFormFromFilters();
      }
    });
    common_vendor.watch(
      ...
      async (next, prev) => {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/cards/index.vue:873", "selectedSoftware change error", error);
        } finally {
          syncFormFromFilters();
        }
      }
      ...
      return common_vendor.e({
        ...
        S: common_vendor.w(({
          ...
          return {
            ...
            c: common_vendor.o(($event) => copyValue(row.key)),
            d: "4177db9f-4-" + i0 + ",4177db9f-3",
            e: common_vendor.p({
        ...
        U: common_vendor.w(({
          ...
          return {
            ...
            c: common_vendor.o(($event) => copyValue(row.ip || "")),
            d: i0,
            e: s0
          };
        }, {
          ...
          return common_vendor.e({
            ...
            b: common_vendor.f(row.machineCodes, (code, k1, i1) => {
              return {
                ...
                d: common_vendor.o(($event) => copyValue(code), code)
              };
            })
          } : {}, {
            c: i0,
        ...
        X: common_vendor.w(({
          ...
          return {
            ...
            c: common_vendor.o(($event) => copyValue(row.fullKey)),
            d: i0,
            e: s0
          };
        }, {
        ...
        aG: common_vendor.f(generatedCards.value, (card, k0, i0) => {
          return {
            ...
            d: common_vendor.o(($event) => copyValue(card), card)
          };
        }),

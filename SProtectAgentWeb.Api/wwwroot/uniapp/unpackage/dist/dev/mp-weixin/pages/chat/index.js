  ...
  setup(__props) {
    ...
    async function startDirectSession() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/chat/index.vue:291", "startDirectSession error", error);
    ...
    async function confirmGroupSession() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/chat/index.vue:361", "confirmGroupSession error", error);
    ...
    async function exportHistory() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/chat/index.vue:381", "exportHistory error", error);
    ...
    async function readImageAsBase64(result, path) {
      ...
      if (typeof common_vendor.index.getFileSystemManager === "function") {
        try {
          ...
          common_vendor.index.__f__("error", "at pages/chat/index.vue:467", "readFileSystem error", error);
        }
      }
    ...
    async function chooseImage() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/chat/index.vue:529", "chooseImage error", error);
      ...
      return common_vendor.e({
        ...
        k: common_vendor.f(activeSession.value.messages, (message, k0, i0) => {
          return common_vendor.e({
            ...
            g: common_vendor.o(($event) => copyContent(message.caption), message.id)
          } : {}) : {
            h: common_vendor.t(message.content),
            i: common_vendor.o(($event) => copyContent(message.content), message.id),
            j: common_vendor.o(($event) => copyContent(message.content), message.id)
          }, {
            k: common_vendor.t(message.time),
            l: common_vendor.o(($event) => copyContent(message.time), message.id),
            m: common_vendor.o(($event) => copyContent(message.time), message.id),
            n: message.id,
            o: message.id,
            p: common_vendor.n(message.sender === "user" ? "self" : "system")
          });
        }),

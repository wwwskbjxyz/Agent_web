  ...
  setup(__props) {
    ...
    async function handleWeChatBind() {
      ...
      try {
        ...
        try {
          ...
          common_vendor.index.__f__("warn", "at pages/index/index.vue:633", "获取用户昵称失败，继续绑定", error);
        }
    ...
    async function handleLogout() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:924", "退出登录失败", error);
    ...
    async function submitSalesQuery() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:960", "submitSalesQuery error", error);
    ...
    common_vendor.onMounted(async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("warn", "at pages/index/index.vue:1061", "自动同步作者凭证失败", error);
      }
      ...
      await Promise.all([
        ...
        appStore.loadChatSessions().catch((error) => {
          common_vendor.index.__f__("warn", "at pages/index/index.vue:1070", "加载即时沟通会话失败", error);
        }),
        appStore.loadBlacklistLogs(100).catch((error) => {
          common_vendor.index.__f__("warn", "at pages/index/index.vue:1073", "加载黑名单日志失败", error);
        })
      ]);
    ...
    common_vendor.watch(
      ...
      (next, prev) => {
        ...
        appStore.loadChatSessions().catch((error) => {
          common_vendor.index.__f__("warn", "at pages/index/index.vue:1087", "切换软件时加载会话失败", error);
        });
        appStore.loadBlacklistLogs(100).catch((error) => {
          common_vendor.index.__f__("warn", "at pages/index/index.vue:1090", "切换软件时加载黑名单日志失败", error);
        });
        resetSalesForm();
      }
    );
      ...
      return common_vendor.e({
        ...
        az: common_vendor.f(paginatedSales.value, (item, k0, i0) => {
          return {
            ...
            c: common_vendor.t(item.activateTime || "-"),
            d: common_vendor.o(($event) => copyValue(item.activateTime || "-"), `${item.card}-${item.activateTime}`),
            e: `${item.card}-${item.activateTime}`
          };
        }),

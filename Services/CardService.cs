...
namespace SProtectAgentWeb.Api.Services
{
    public class CardService
    {
        ...
        public async Task<ActivatedCardCountResponse> CountActivatedCardsAsync(ActivatedCardCountQuery query)
        {
            var creators = await ResolveCreatorUsernamesAsync(
                query.Software,
                query.WhomList,
            ...
            var result = await Task.Run(() => SqliteBridge.QueryActivatedCards(dbPath, options)).ConfigureAwait(false);

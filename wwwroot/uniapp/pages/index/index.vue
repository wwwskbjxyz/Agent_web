  ...
  <view class="page">
    <view class="hero glass-card">
      ...
      <view class="hero-meta">
       ...
       <!-- <button class="meta-button" @tap="goAgents">代理管理</button> -->
      </view>
    </view>
...
const { dashboard, systemStatus, profile, selectedSoftware, cardTypes, agents, theme, chatUnreadCount, hasNewBlacklistLogs } =
